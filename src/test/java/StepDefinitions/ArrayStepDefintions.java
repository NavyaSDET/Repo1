...
public class ArrayStepDefintions {
	...
	public void the_user_navigates_to_practice_question_page() {
		...
		Assert.assertTrue(ip.validateElementDisplayed(ap.searchTheArrayQuestion));
	}
	...
	public void the_user_enter_valid_python_code_in_try_editor_page_sheet_and_for_the_question_run_button(
	...
	public void the_user_enter_valid_python_code_in_try_editor_page_sheet_and_for_the_question_submit_button(
	...
	public void the_user_should_be_presented_with_the_run_result(String sheetName, int rowNumber)
			...
			io.cucumber.core.internal.com.fasterxml.jackson.databind.exc.InvalidFormatException, IOException,
			OpenXML4JException {
		...
		Assert.assertEquals(ip.getTextForElement(ap.practiceQuestionOutPut), expectedOutput);
	}
