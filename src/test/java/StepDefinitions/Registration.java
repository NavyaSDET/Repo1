...
public class Registration {
	...
	public void the_user_clicks_register_button_with_all_fields_empty_on_registration_form_from_sheetname(String string,
	...
	public void the_user_clicks_register_button_after_entering_username_with_other_fields_empty_on_registration_form_from_sheetname(
	...
	public void the_user_clicks_register_button_after_entering_username_and_password_with_password_confirmation_field_empty_on_registration_form_from_sheetname(
			String string, Integer int1)
			throws InvalidFormatException, IOException, OpenXML4JException, InterruptedException {
	...
	public void the_user_clicks_register_button_after_entering_a_username_with_spacebar_characters_other_than_digits_and_symbols_on_registration_form_from_sheetname(
			String string, Integer int1)
			throws InvalidFormatException, IOException, OpenXML4JException, InterruptedException {
	...
	public void the_user_clicks_register_button_after_entering_a_password_with_only_numeric_data_on_registration_form_from_sheetname(
			String string, Integer int1)
			throws InvalidFormatException, IOException, OpenXML4JException, InterruptedException {
	...
	public void the_user_clicks_register_button_after_entering_a_password_with_characters_less_than_eight_on_registration_form_from_sheetname(
			String string, Integer int1)
			throws InvalidFormatException, IOException, OpenXML4JException, InterruptedException {
	...
	public void the_user_clicks_register_button_after_entering_different_passwords_in_password_and_password_confirmation_fields_on_registration_form_from_sheetname(
			String string, Integer int1)
			throws InvalidFormatException, IOException, OpenXML4JException, InterruptedException {

		// RGPage.enterUsernameAndPswdAndConfirmPswdAndClickRegisterBtn("rihannanhdgdgh34",
		// "sesesdxftrdf45", "kjokpokmnokiu89");
	...
	public void the_user_clicks_register_button_after_user_fills_registration_form_from_sheetname_and_row(String string,
			Integer int1) throws IOException, OpenXML4JException, InterruptedException {
