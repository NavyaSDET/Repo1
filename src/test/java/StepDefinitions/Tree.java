...
public class Tree {
	 ...
	 * public void
	 * nothing_happens_to_the_editor_page_and_no_error_message_is_displayed() {
	 * 
	 ...
	 * public void the_user_see_error_msg_in_alert_window(String
	 * expectedErrorHeader, String expectedErrorMessage) {
	 * 
	 * treePage.check_When_InvalidCode_In_Editor("dsportalapp.herokuapp.com says",
	 * "NameError: name 'printf' is not defined on line 1");
