...
Scenario Outline: DS Algo Sign in Page with blank info
 ...
 Scenario Outline: DS Algo Sign in Page with blank password
 Given  The user is on the DS Algo Sign in Page
...
Scenario Outline: DS Algo Sign in Page  with blank username
 Given  The user is on the DS Algo Sign in Page
...
Scenario Outline: DS Algo Sign in Page with invalid username and password
 Given  The user is on the DS Algo Sign in Page
...
Scenario Outline: DS Algo Sign in Page with valid username and invalid password
 Given  The user is on the DS Algo Sign in Page
...
Scenario Outline: DS Algo Sign in Page  with valid username and Valid password
 Given  The user is on the DS Algo Sign in Page
